      ...
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton(
            ...
            itemBuilder: (context) => [
              PopupMenuItem(child: Obx(() => Text(controller.name.value))),
              PopupMenuItem(
        ...
        child: SingleChildScrollView(
          ...
          child: Obx(
            () {
              ...
              return Column(
                children: [
                  const Text('Top Movie', style: TextStyle(fontSize: 20)),
                  Container(
                  ...
                  const Text('Latest Update', style: TextStyle(fontSize: 20)),
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return ZoomTapAnimation(
                        ...
                        onTap: () {
                          Get.to(() => DetailView(movie: controller.movies[index]), binding: DetailBinding());
                        },
                        child: Stack(
                          children: [
                            ClipRRect(
